...
*/
function initLogin(callback: any) {
    debug('Getting login');
    request.get({
            url: psnURL.SignIN
            , headers : {
...
* @param 	Function callback - Calls this function once the login is complete
*/
function getLogin(callback: any, referer: any, params?: any) {
...
function followRedirect(callback: any, url: any, referer: any) {
    ...
    request.get(url
        ,{
            ...
            if (!error) {
                const codeResult = codeRegex.exec(unescape(response.headers.location));
                if (codeResult) getAccessToken(codeResult[1])
            }
            else {
                debug('ERROR: ' + error)
            }
...
*/
function getAccessToken(authCode: any, callback?: any) {
...
* @param 	Function 	callback 	- Calls this function once the request is complete
*/
function psnGETRequest (url: any, callback: any) {
    var
        reqOptions = {
            url: url
            ,method : 'GET'
    ...
    ;
    request.get(reqOptions, function(error: any, response: any, body: any) {
        let responseJSON;
        responseJSON = JSON.parse(body);
        if(!error) {
...
* @param 	Function 	callback 	- Calls this function once the request is complete
*/
function psnPOSTRequest (url: any, callback: any) {
    var
        reqOptions = {
            url: url
            ,method : 'POST'
    ...
    ;
    request.post(reqOptions, function(error: any, response: any, body: any) {
        let responseJSON;
        responseJSON = JSON.parse(body);
        if(!error) {
            if (response.statusCode == 200) {
...
* @param 	Function callback - Calls this function once the login is complete
*/
exports.init = function(params: any, callback: any) {
    if (typeof params === 'object' && ('email' in params && 'password' in params)) {
        ...
        Object.keys(psnURL).forEach(function(key: any) {
...
* @param 	Function 	callback 	- Calls this function once the request is complete
*/
exports.getProfile = function (psnid: any, callback: any) {
...
* @param 	Function 	callback 	- Calls this function once the request is complete
*/
exports.getTrophies = function (psnid: any, iconsize: any, offset: any, limit: any, callback: any) {
    if (accessToken.length > 1) {
...
* @param 	Function 	callback 	- Calls this function once the request is complete
*/
exports.getGameTrophyGroups = function (psnid: any, npCommID: any, callback: any) {
    if (accessToken.length > 1) {
...
* @param 	Function 	callback 	- Calls this function once the request is complete
*/
exports.getGameTrophies = function (psnid: any, npCommID: any, groupId: any, callback: any) {
    if (accessToken.length > 1) {
...
* @param 	Function 	callback 	- Calls this function once the request is complete
*/
exports.getTrophy = function (psnid: any, npCommID: any, groupId: any, trophyID: any, callback: any) {
    if (accessToken.length > 1) {
...
*/
function psnGETRequestDEBUG (url: any, callback: any) {
    var
        options = {
            url: url
            ,method : 'GET'
...
exports.GET = function (url: any, callback: any) {
